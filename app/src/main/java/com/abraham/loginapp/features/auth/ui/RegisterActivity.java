...
import com.abraham.loginapp.features.auth.viewmodel.RegisterViewModel; // Importamos el ViewModel
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editFullName = findViewById(R.id.edit_username); // Esto puede ser un error de ID en tu layout
        // Si 'edit_username' es para username, deberías usar otro ID para fullName
